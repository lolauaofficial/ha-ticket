    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('6d6ee8')
          .setAuthor({name: `${interaction.user.username}'s Ticket`, iconURL: 'https://twitter.com/MarlonGaming13/photo'})
          .setDescription('Select the category of your ticket')
          .setFooter({text: `${client.user.tag} || Hosted by Hosting Area`, iconURL: client.user.displayAvatarURL()})
          .setTimestamp();
